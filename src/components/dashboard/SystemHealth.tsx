    ...
    <div className="bg-white shadow-2xs rounded-lg">
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Real-time system status and monitoring</p>
          </div>
      ...
      <div className="p-6">
            ...
            return (
              ...
              >
                ...
                <div className="mt-4 flex items-center justify-between text-xs text-gray-400">
                  <span>Checked {new Date(check.lastChecked).toLocaleTimeString()}</span>
                  {check.responseTime && (
                    <span
                      className={cn(
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <button
            type="button"
            className="rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
            Refresh Status
          </button>
        </div>
