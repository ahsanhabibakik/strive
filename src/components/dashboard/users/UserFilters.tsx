  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4">
      ...
      <select
        ...
        className="block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-2xs focus:outline-hidden focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
      >
