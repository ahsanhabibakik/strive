  ...
  const mainFeatures = [
    {
      ...
      description: "Find scholarships, competitions, internships, and events from around the world with our powerful search and filtering system.",
      color: "text-blue-600",
      bgColor: "bg-blue-100",
    ...
    },
    {
      ...
      description: "Create SMART goals, track your progress, and stay motivated with our comprehensive goal management system.",
    ...
    },
    {
      ...
      description: "Get detailed analytics on your applications, success rates, and progress towards your personal and professional goals.",
  ...
  const additionalFeatures = [
    {
      ...
      description: "Never miss a deadline with personalized notifications for applications and goal milestones.",
      emoji: "🔔",
    ...
    },
    {
      ...
      description: "Work with teams, share goals, and collaborate on applications with built-in team features.",
      emoji: "👥",
      color: "text-blue-600"
    },
    {
    ...
    },
    {
      ...
      description: "Access guides, templates, and resources to improve your applications and goal setting.",
      emoji: "📚",
    ...
    },
    {
      ...
      description: "Connect with like-minded individuals from around the world pursuing similar goals.",
      emoji: "🌍",
  ...
  return (
    <section ref={sectionRef} id="features" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-20 animate-bounce" style={{animationDelay: '2s', animationDuration: '5s'}}>
          <Heart className="h-4 w-4 text-pink-300 opacity-30" />
        </div>
        <div className="absolute bottom-40 left-1/4 animate-bounce" style={{animationDelay: '1s', animationDuration: '3s'}}>
          <Zap className="h-5 w-5 text-yellow-300 opacity-25" />
        </div>
        <div className="absolute bottom-20 right-1/3 animate-bounce" style={{animationDelay: '3s', animationDuration: '4s'}}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 relative z-10">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            <span className="inline-block animate-in slide-in-from-left duration-700">Everything You Need to </span>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto animate-in fade-in duration-1000 delay-400">
            From opportunity discovery to goal achievement, we provide all the tools you need 
            ...
            return (
              <Card 
                ...
                className={cn(
                  ...
                  isVisible ? "animate-in slide-in-from-bottom duration-700" : "opacity-0 translate-y-10"
                )}
              ...
              >
                <CardContent className="p-8 relative">
                  ...
                  <Button variant="ghost" className="p-0 h-auto text-sm group-hover:translate-x-2 transition-all duration-300 group-hover:text-blue-600">
                    Learn more
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden group">
          ...
          <div className="absolute inset-0 opacity-20">
            ...
            <div className="absolute bottom-4 right-16 animate-bounce" style={{animationDelay: '0.5s'}}>
          ...
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <p className="text-xl mb-8 opacity-90 group-hover:opacity-100 transition-opacity duration-300">
              Join thousands of successful individuals who are using Strive to discover opportunities 
              and achieve their goals.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/auth/signup">
                <Button size="lg" variant="secondary" className="w-full sm:w-auto px-8 hover:scale-105 transition-all duration-300 hover:shadow-xl group relative overflow-hidden">
              ...
              <Link href="#opportunities">
                <Button size="lg" variant="outline" className="w-full sm:w-auto px-8 border-white/20 text-white hover:bg-white/10 hover:scale-105 transition-all duration-300 hover:shadow-xl group">
