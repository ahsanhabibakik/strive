  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (konamiCode.length === konamiSequence.length && 
        ...
        message.className = 'fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[9999] bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-2xl shadow-2xl animate-bounce text-xl font-bold';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white relative">
        ...
        {currentSection === 'hero' && (
          <div className="fixed top-20 right-20 animate-bounce pointer-events-none z-10 hidden lg:block" style={{animationDuration: '3s'}}>
