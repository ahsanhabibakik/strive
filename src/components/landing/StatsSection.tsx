...
export function StatsSection() {
  ...
  return (
    <section ref={sectionRef} id="stats" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      {/* Confetti Effect */}
      {confettiTrigger && (
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-20 animate-bounce" style={{animationDelay: '2s', animationDuration: '4s'}}>
        ...
        <div className="absolute bottom-20 right-1/3 animate-bounce" style={{animationDelay: '3s', animationDuration: '5s'}}>
          <Rocket className="h-8 w-8 text-purple-300 opacity-20" />
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 relative z-10">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            <span className="inline-block animate-in slide-in-from-left duration-700">Trusted by </span>
            ...
            <span className="inline-block animate-in slide-in-from-left duration-700 delay-400"> Worldwide</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto animate-in fade-in duration-1000 delay-600">
            Join a thriving community of goal-achievers who are discovering opportunities 
              ...
              >
                ...
                <div className="mb-4">
                  <div className={cn(
                    ...
                    hasValue 
                      ? "text-transparent bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text scale-110" 
                      : "text-gray-900"
                  )}>
                  ...
                  <div className="text-xl font-semibold text-gray-800 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 group-hover:bg-clip-text transition-all duration-300">
                    {stat.label}
                  </div>
                  ...
                  {/* Fun hover bar */}
                  <div className="w-0 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mt-4 group-hover:w-full transition-all duration-500 rounded-full" />
                </div>
              </div>
            );
          })}
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {achievements.map((achievement, index) => (
              <div key={index} className="text-center p-6 rounded-2xl bg-gradient-to-br from-yellow-50 to-orange-50 border border-yellow-100">
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Every day, more people discover life-changing opportunities and achieve their goals with Strive. 
