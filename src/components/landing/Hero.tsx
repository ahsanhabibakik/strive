      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            The complete Next.js starter template with authentication, billing, analytics, 
            and everything you need to launch your SaaS application quickly.
          </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <div className="rounded-lg bg-white/5 p-4 text-center">
              ...
              <p className="mt-2 text-sm font-semibold text-gray-900">Secure Auth</p>
            </div>
            <div className="rounded-lg bg-white/5 p-4 text-center">
              <CurrencyDollarIcon className="mx-auto h-8 w-8 text-indigo-600" />
              <p className="mt-2 text-sm font-semibold text-gray-900">Stripe Billing</p>
            </div>
            <div className="rounded-lg bg-white/5 p-4 text-center">
              <ChartBarIcon className="mx-auto h-8 w-8 text-indigo-600" />
              <p className="mt-2 text-sm font-semibold text-gray-900">Analytics</p>
            </div>
          </div>
        </div>
      </div>
