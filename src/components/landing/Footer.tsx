      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <div className="text-2xl font-bold text-indigo-600">Strive</div>
            <p className="text-sm leading-6 text-gray-600">
              The complete Next.js starter template for building production-ready SaaS applications. 
              Save months of development time with our comprehensive feature set.
            </p>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="flex items-center justify-between">
            <p className="text-xs leading-5 text-gray-500">
              &copy; 2025 Strive. All rights reserved.
            </p>
