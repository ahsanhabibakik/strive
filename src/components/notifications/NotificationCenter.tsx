...
export function NotificationCenter({ notifications: initialNotifications, userId }: NotificationCenterProps) {
  ...
  const filters = [
    ...
    { key: 'billing', label: 'Billing', count: notifications.filter(n => n.type === 'billing').length },
                ...
                <div className="flex items-start space-x-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-x-2 mb-1">
                      ...
                      <span className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${getNotificationColor(notification.type)} ${
                        notification.type === 'billing' ? 'text-green-700 ring-green-600/20' :
                        notification.type === 'security' ? 'text-red-700 ring-red-600/20' :
                        notification.type === 'system' ? 'text-yellow-700 ring-yellow-600/20' :
                        notification.type === 'feature' ? 'text-blue-700 ring-blue-600/20' :
                        notification.type === 'maintenance' ? 'text-orange-700 ring-orange-600/20' :
                        ...
                        {notification.type === 'billing' && (
                          <div className="text-sm">
                            <div className="flex items-center justify-between">
                              ...
                              <span className="font-medium">${(notification.data.amount / 100).toFixed(2)}</span>
                            </div>
                            <div className="flex items-center justify-between">
