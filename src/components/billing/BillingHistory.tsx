...
export function BillingHistory({ customerId }: BillingHistoryProps) {
  ...
  const getStatusBadge = (status: Invoice['status']) => {
    const baseClasses = "inline-flex items-center gap-x-1.5 rounded-md px-2 py-1 text-xs font-medium";
      ...
      <div className="bg-white rounded-lg shadow-xs border border-gray-200">
        ...
        <div className="p-6">
          <div className="text-center py-8">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">Error loading billing history</h3>
