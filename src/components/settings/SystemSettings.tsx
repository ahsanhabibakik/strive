                  ...
                  <div className="ml-3 flex-1">
                    ...
                    <div className="mt-3">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 border border-yellow-300 rounded-md shadow-2xs focus:ring-yellow-500 focus:border-yellow-500"
                        disabled={!canEdit}
                      />
                    </div>
                  </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Enable or disable new user account creation</p>
              </div>
              <ToggleSwitch
            ...
            <div className="flex items-center justify-between">
              ...
              <ToggleSwitch
                ...
                onChange={value =>
                  updateConfig(["registration", "requireEmailVerification"], value)
                }
