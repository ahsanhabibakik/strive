    ...
    <div className="min-h-screen bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-2xl max-w-md w-full mx-4">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded-sm">
            ✅ Component classes working
          </div>
          <div className="bg-purple-100 border border-purple-400 text-purple-700 px-4 py-3 rounded-sm">
            ✅ Utility classes working
          </div>
        </div>
        <button className="mt-6 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-sm transition-colors duration-200">
          Test Button
        </button>
      </div>
    </div>
