      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        ...
        {RBAC.hasPermission(currentUser, 'users:write') && (
          <div className="flex gap-2">
            <button
              type="button"
              className="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-3 ring-inset ring-gray-300 hover:bg-gray-50"
            >
              Export Users
            </button>
            <button
