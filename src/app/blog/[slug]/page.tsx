            ...
            <div className="prose prose-lg prose-gray max-w-none">
              <div 
                dangerouslySetInnerHTML={{ 
                  __html: post.content.replace(/\n/g, '<br/>').replace(/#{1,6} (.*)/g, '<h2 class="text-2xl font-semibold text-gray-900 mt-8 mb-4">$1</h2>') 
                }}
                    ...
                    {post.author.social && (
                      <div className="flex gap-4 text-sm">
                        {post.author.social.twitter && (
                          <a href={`https://twitter.com/${post.author.social.twitter.replace('@', '')}`} 
                             className="text-indigo-600 hover:text-indigo-700">
                            Twitter
                          </a>
                        )}
                        {post.author.social.linkedin && (
                          <a href={`https://linkedin.com/in/${post.author.social.linkedin}`}
                             className="text-indigo-600 hover:text-indigo-700">
                            LinkedIn
                          </a>
                        )}
                        {post.author.social.github && (
                          <a href={`https://github.com/${post.author.social.github}`}
                             className="text-indigo-600 hover:text-indigo-700">
                            GitHub
                          </a>
                        )}
                        {post.author.social.website && (
                          <a href={post.author.social.website}
                             className="text-indigo-600 hover:text-indigo-700">
                            Website
                          </a>
                        )}
